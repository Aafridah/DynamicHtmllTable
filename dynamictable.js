...
let countryRowSpan = 0, isCountryRow = false, isStateRow = false;
...
var table = document.getElementById('tableDynamic');
      ...
      data.forEach(country => {
        ...
        var cellCountry = row.insertCell(-1);
                cellCountry.innerHTML = country.name;
                cellCountry.id = "country" + country.id;
        ...
        country.states.forEach(state => {
            ...
            if(isCountryRow){
                ...
                cellState.innerHTML = state.name;
                cellState.id = "state"+ state.id;
                isStateRow = false;
            }
            else{
                rowState = table.insertRow(-1);
            ...
            state.cities.forEach(city => {
                ...
                if(isCountryRow){
                    ...
                    cellCity.innerHTML = city.name;
                    cellCity.id ="city" + city.id;
                    isStateRow = false;
                    isCountryRow = false;
                }
                else if(isStateRow){
                    var cellCity = rowState.insertCell(-1);
                    cellCity.innerHTML = city.name;
                    cellCity.id ="city" + city.id;
                    isStateRow = false;
                }
                else {
                    var rowCity = table.insertRow(-1);
                    var cellCity = rowCity.insertCell(-1);
                    cellCity.innerHTML = city.name;
                    cellCity.id ="city" + city.id;
                }
            ...
            isCountryRow = false;
            countryRowSpan += state.cities.length == 0? 1: state.cities.length;
            document.getElementById(`state${state.id}`).rowSpan = state.cities.length == 0? 1: state.cities.length;
        });

        document.getElementById(`country${country.id}`).rowSpan = countryRowSpan == 0? 1 : countryRowSpan;
